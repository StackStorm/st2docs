...
* `Slack <https://stackstorm-community.slack.com>`_:  If you're not slacker yet, good excuse to become one! Slack allows you to search in archives. This is great if you want to know if someone else had an issue that you are facing! Come hang out. Register `here <https://stackstorm.com/community-signup>`_.
