...
* **API Docs:** Auto-generated REST API docs - see `api.stackstorm.com <https://api.stackstorm.com>`_.
...
* **Improved** `Mistral <https://wiki.openstack.org/wiki/Mistral>`_  **integration:** simplified Mistral DSL for |st2| actions, visibility of workflow executions, and reliable of |st2|-Mistral communication. Includes Mistral improvements, features, and fixes.
