...
* **Migrate away from MongoDB:** Replace Mongo, to reduce operational overhead, improve performance, and simplify licensing.
...
* **More integration packs:** push more content to the community to help work with most common and widely used tools. Tell us if there is tool you love and think we should integrate with, or better yet write a pack!.
...
* **API:** Generate REST API docs.
* **Monitoring:** Create |st2| monitoring guidelines.	
