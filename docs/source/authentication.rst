...
|                             |          |                            |                                                                                                                                          | 
+-----------------------------+----------+----------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| group_pattern               | no       | `(|(& (objectClass=*)`     | LDAP subtree pattern for user groups. Both user_dn and username are escaped and then interpolated into this string (see example.)        |                      
|                             |          |                            |                                                                                                                                          | 
|                             |          |                            |                                                                                                                                          | 
|                             |          |                            |                                                                                                                                          | 
|                             |          |                            |                                                                                                                                          | 
