 ...
 * The :doc:`Inquiries </inquries>` API has been promoted from the ``/exp`` path to ``/api/v1``. If you have any external systems that use this API they will need to be updated to use the new path. st2client has been updated to use the new path.
