...
Python 3.6 is not available in the base Ubuntu Xenial distro, but the following instructions can add unofficial 3rd party `Python PPA repository <https://launchpad.net/~deadsnakes/+archive/ubuntu/ppa>`_ that provides it.
