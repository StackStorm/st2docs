...
It can also be deployed by installing the latest version of `st2web` package and serving ``/opt/stackstorm/static/webui`` folder with the web server of your choice.
