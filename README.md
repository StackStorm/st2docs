...
For Debian/Ubuntu: ``sudo apt-get install libpython-dev libssl-dev libldap2-dev libsasl2-dev``

For RHEL/CentOS: `` sudo yum install python-devel openssl-devel gcc libldap2-dev libsasl2-dev``
